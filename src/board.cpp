...
void UpdateListsMaterial(s_Board *pos)
{
    ...
    int piece, sq, sq64, colour;

    for (sq64 = 0; sq64 < BRD_SQ_NUM; sq64++)
    {
        sq = sq64;
        piece = pos->pieces[sq64];
...
void PrintBoard(const s_Board *pos)
{
    ...
    // Side To Play
    cout << "Side :" << SideChar[pos->side] << "\n";

    // Enpassant Square
    cout << "EnPassant :" << pos->enPas << "\n";
    ...
    // Hash Key
    cout << "Hash Key is: " << std::hex << std::uppercase << pos->posKey << std::dec << std::nouppercase << "\n";
}